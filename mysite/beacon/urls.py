...
urlpatterns = [
    ...
    # path("student/course/<int:pk>/", views.student_course_detail, name="student_course_details"),
    path("student/lesson/<int:pk>/", views.student_lesson_details, name="student_lesson_detail"),
